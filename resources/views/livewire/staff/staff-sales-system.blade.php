                    ...
                    <div class="sale-preview p-4" id="saleReceiptPrintContent">
                        ...
                        <div class="invoice-footer mt-4">
                            ...
                            <div class="border-top pt-3" style="font-size: 0.7rem; line-height: 1.2;">
                                <p class="text-center mb-1" style="margin-bottom: 0.3rem;"><strong>ADDRESS :</strong> 254, Warana Road, Thihariya, Kalagedihena.</p>
                                <p class="text-center mb-1" style="margin-bottom: 0.3rem;"><strong>TEL :</strong> 072 3797070, <strong>EMAIL :</strong> amharprofessional10765@gmail.com</p>
