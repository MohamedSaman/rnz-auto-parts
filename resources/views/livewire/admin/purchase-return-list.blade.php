<div class="container-fluid py-3">
    <div class="busy-header-card mb-3">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div>
                ...
                <small class="text-white-50">Mode: {{ $pageMode === 'modify' ? 'Modify Entry' : 'List Entry' }}</small>
            </div>
            <div class="d-flex align-items-center gap-2">
                <kbd class="erp-kbd">F4</kbd>
            </div>
        </div>
    </div>
    ...
    <div class="busy-tabs mb-4">
        ...
        <a href="{{ route('admin.purchase-return-modify') }}" class="busy-tab {{ $pageMode === 'modify' ? 'active' : '' }}">
            <i class="bi bi-pencil-square"></i> Modify
        </a>
        <a href="{{ route('admin.purchase-return-list') }}" class="busy-tab {{ $pageMode === 'list' ? 'active' : '' }}">
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0 fw-bold"><i class="bi bi-list-check me-2"></i>Purchase Returns</h5>
