        ...
        <div class="global-header" style="border-bottom: 3px solid #000000; padding-bottom: 15px; margin-bottom: 20px;">
            <div style="display: flex; align-items: center; justify-content: space-between;">
                ...
                <div style="flex: 0 0 150px;">
                    <img src="{{ public_path('images/RNZ.png') }}" alt="Logo" style="max-height:80px;">
                </div>
                <!-- Center: Company Name -->
                <div style="flex: 1; text-align: center;">
                    <h2 style="font-size: 2.5rem; letter-spacing: 2px; font-weight: bold; margin-bottom: 0;">RNZ AUTO PARTS</h2>
                    <p style="color: #666; font-size: 0.875rem; margin-bottom: 0;">All type of auto parts</p>
                </div>
                <!-- Right:  & Invoice -->
